...
const Footer = () => {
  ...
  const socialLinks = [
    { icon: FaGithub, href: "https://github.com/hassannawaz02", label: "GitHub" },
    { icon: FaLinkedin, href: "https://www.linkedin.com/in/hassan-nawaz-414983331/", label: "LinkedIn" },
    // { icon: FaTwitter, href: "https://x.com/yourusername", label: "Twitter" },
    // { icon: FaInstagram, href: "https://instagram.com/yourusername", label: "Instagram" },
    // { icon: FaYoutube, href: "https://www.youtube.com/yourusername", label: "YouTube" },
    // { icon: FaTelegram, href: "https://t.me/yourusername", label: "Telegram" },
    { icon: MdEmail, href: "mailto:hassanniazi918@gmail.com", label: "Email" }
  ];
  ...
  return (
    <footer className="relative bg-black border-t border-white/10">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          <p>© {currentYear} Hassan Nawaz. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
