  ...
  const projects: Project[] = [
    {
      ...
      githubLink: "https://github.com/hassannawaz02/Agentia_World.git",
      liveLink: "https://agentia-world-sigma.vercel.app/",
      type: "project",
      icon: FaCode
    },
    {
    ...
    {
      title: "ResumeBuilder",
      description: "A simple resume builder built with HTML, CSS, and TypeScript. Takes user input and generates a styled resume without any backend or download functionality.",
      image: "/pyquiz.png",
      technologies: ["Html", "Css", "TypeScript"],
      githubLink: "https://github.com/hassannawaz02/hackathon_project01",
      liveLink: "https://giaic-omega.vercel.app/",
      type: "project",
      icon: FaDatabase
    },{
      title: "Personal Library",
      description: "A Python program to manage your personal book collection. This tool allows you to add, remove, update, search for books, and track your reading progress.",
      image: "/blogsite.png",
      technologies: ["Python"],
      githubLink: "https://github.com/hassannawaz02/Personal_Library.git",
      // liveLink: "https://agentia-world-sigma.vercel.app/",
      type: "project",
      icon: FaCode
    },
    {
      ...
      description: "Growth Mindset File Transformer is a Streamlit web app designed to help users upload, clean, filter, visualize, and convert data files (CSV, Excel) effortlessly.",
      image: "/nikejordee.png",
      technologies: ["Streamlit", "Python"],
      githubLink: "https://github.com/hassannawaz02/Groth_Mindset.git",
      liveLink: "https://grothmindset-hkn.streamlit.app/",
      type: "project",
      icon: FaServer
    },
    {
